...
See `index.html`. It is a standalone html file that shows a 1980s arcade, with the machines (cabinets): Galaxian, Defender, Star Force.

See `pacman.html`. It is a standalone html file that emulates classic arcade game Pac-Man (1980).

Add Pac-Man to the arcade in `index.html`.
