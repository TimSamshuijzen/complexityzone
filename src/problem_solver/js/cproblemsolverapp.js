      ...
      onClick: function() {
        ...
        lModalPanel.dialogPanel.messagePanel = new cPanel({
          ...
          innerHTML: 
            ...
            '<br />\n' +
            'Problem Solver is a game tree viewer, for analyzing puzzles, problems and algorithms.\n' +
            'Simple puzzles (see the puzzles in the "examples" menu) can be modelled in Problem Solver, and it\'s solutions (goals) is visible in the multiverse viewer.\n' +
            '<br />\n'
