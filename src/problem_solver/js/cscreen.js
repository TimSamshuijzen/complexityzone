...
function cScreen(aApp, aContainer) {
  cBase.call(this);
  cDebug.log('debug', 'Created instance of cScreen.');
...
(function() {
  ...
  cScreen.prototype.setup = function() {
    ...
    if (this.screenContainer == null) {
      ...
      cDOM.registerEvent(this.screenContainer, 'mousedown', this.onMouseDown, this);
      cDOM.registerEvent(this.screenContainer, 'mousemove', this.onMouseMove, this);
      cDOM.registerEvent(this.screenContainer, 'touchstart', this.onTouchDown, this);
      cDOM.registerEvent(this.screenContainer, 'touchmove', this.onTouchMove, this);

      cDOM.registerEvent(this.screenContainer, 'mouseup', this.onMouseUp, this);
      //cDOM.registerEvent(this.screenContainer, 'mouseout', this.onMouseOut, this);
      cDOM.registerEvent(this.screenContainer, 'touchend', this.onTouchUp, this);
      cDOM.registerEvent(this.screenContainer, 'touchcancel', this.onTouchUp, this);
    }
  ...
  cScreen.prototype.updateHovers = function() {
    ...
    if (lNewMousePanelHovers.length > 1) {
      for (var lpi = (lNewMousePanelHovers.length - 2); lpi >= 0; lpi--) {
        if (lNewMousePanelHovers[lpi].panel !== lNewMousePanelHovers[lpi + 1].panel.parentPanel) {
  ...
  cScreen.prototype.onMouseDown = function(aEvent) {
    if (!this.mouseDown) {
      ...
      // do bubble
      for (var lpi = (this.mousePanelHovers.length - 1); (lpi >= 0) && (lpi < this.mousePanelHovers.length); lpi--) {
      ...
      if (this.dragObject != null) {
        if (this.dragObject.panel) {
          if (this.dragObject.panel.onDrag) {
            this.dragObject.panel.left = (this.dragObject.startPanelX + (this.mouseX - this.dragObject.startMouseX));
            this.dragObject.panel.top = (this.dragObject.startPanelY + (this.mouseY - this.dragObject.startMouseY));
            this.dragObject.panel.rerenderParent();
  ...
  cScreen.prototype.onMouseUp = function() {
    if (this.mouseDown) {
      ...
      var lTap = (((lMouseUpTimeMs - this.mouseDownTimeMs) < 200) &&
                  (Math.abs(this.mouseDownX - this.mouseX) <= 4) &&
                  (Math.abs(this.mouseDownY - this.mouseY) <= 4));
      this.updateHovers();
      if (this.dragObject != null) {
        for (var lpi = (this.mousePanelHovers.length - 1); (lpi >= 0) && (lpi < this.mousePanelHovers.length); lpi--) {
  ...
  cScreen.prototype.onTouchDown = function(aEvent) {
  ...
  cScreen.prototype.onTouchMove = function(aEvent) {
    if (aEvent.preventDefault) {
      aEvent.preventDefault();
    }
    if (aEvent.changedTouches) {
  ...
  cScreen.prototype.onTouchUp = function(aEvent) {
    if (aEvent.preventDefault) {
      aEvent.preventDefault();
    }
    this.onMouseUp();
